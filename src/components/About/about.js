    ...
    return (
      <div className={global.pageContent}>
        ...
        <section className={global.section}>
          <article>
            <h2 className={global.heading2}>Nail Art</h2>
            ...
            <h2 className={global.heading2}>Quality</h2>
            ...
            <h2 className={global.heading2}>Price</h2>
            ...
            <h2 className={global.heading2}>Don't Wait</h2>
